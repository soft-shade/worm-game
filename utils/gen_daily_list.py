...
# NOTE: assets/daily_list.txt is hand-maintained from here on. This
# generator is kept for reference / bootstrapping a fresh list; do not
# re-run it over an existing production list or curated entries
# (holiday pairs, April Fools, etc.) will be overwritten.
